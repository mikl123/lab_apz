...
class LoggingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getData = channel.unary_unary(
                '/greeter.LoggingService/getData',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.Database.FromString,
                _registered_method=True)
...
def add_LoggingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getData': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.Database.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'greeter.LoggingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('greeter.LoggingService', rpc_method_handlers)
...
class LoggingService(object):
    ...
    def getData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            service__pb2.Database.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class MessageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.getData = channel.unary_unary(
                '/greeter.MessageService/getData',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.Status.FromString,
                _registered_method=True)
...
def add_MessageServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'greeter.MessageService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('greeter.MessageService', rpc_method_handlers)
