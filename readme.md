...
Для тестування retry кореневій папці logging-service є `add_delay = True # needed for retry system check.` який штучно додає delay, щоб тільки третя спроба зареєструвати повідомлення була успішна.
